...
class Normals(Enum):
    ...
    CanUSA2071_2100Hadley45 = ["Canada-USA 2071-2100", 2091, 2100, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2071_2100]
    CanUSA2061_2090Hadley45 = ["Canada-USA 2061-2090", 2081, 2090, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2061_2090]
    CanUSA2051_2080Hadley45 = ["Canada-USA 2051-2080", 2071, 2080, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2051_2080]
    CanUSA2041_2070Hadley45 = ["Canada-USA 2041-2070", 2061, 2070, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2041_2070]
    CanUSA2031_2060Hadley45 = ["Canada-USA 2031-2060", 2051, 2060, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2031_2060]
    CanUSA2021_2050Hadley45 = ["Canada-USA 2021-2050", 2041, 2050, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2021_2050]
    CanUSA2011_2040Hadley45 = ["Canada-USA 2011-2040", 2031, 2040, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2011_2040]
    CanUSA2001_2030Hadley45 = ["Canada-USA 2001-2030", 2021, 2030, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA2001_2030]
    CanUSA1991_2020Hadley45 = ["Canada-USA 1991-2020", 2011, 2020, ClimateModel.Hadley, RCP.RCP45, ShortNormals.CanUSA1991_2020]

    ### Hadley model + RCP 8.5
    CanUSA2071_2100Hadley85 = ["Canada-USA 2071-2100", 2091, 2100, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2071_2100]
    CanUSA2061_2090Hadley85 = ["Canada-USA 2061-2090", 2081, 2090, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2061_2090]
    CanUSA2051_2080Hadley85 = ["Canada-USA 2051-2080", 2071, 2080, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2051_2080]
    CanUSA2041_2070Hadley85 = ["Canada-USA 2041-2070", 2061, 2070, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2041_2070]
    CanUSA2031_2060Hadley85 = ["Canada-USA 2031-2060", 2051, 2060, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2031_2060]
    CanUSA2021_2050Hadley85 = ["Canada-USA 2021-2050", 2041, 2050, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2021_2050]
    CanUSA2011_2040Hadley85 = ["Canada-USA 2011-2040", 2031, 2040, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2011_2040]
    CanUSA2001_2030Hadley85 = ["Canada-USA 2001-2030", 2021, 2030, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA2001_2030]
    CanUSA1991_2020Hadley85 = ["Canada-USA 1991-2020", 2011, 2020, ClimateModel.Hadley, RCP.RCP85, ShortNormals.CanUSA1991_2020]

    ### GCM4 model + RCP 4.5
    CanUSA2071_2100RCM445 = ["Canada-USA 2071-2100", 2091, 2100, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2071_2100]
    CanUSA2061_2090RCM445 = ["Canada-USA 2061-2090", 2081, 2090, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2061_2090]
    CanUSA2051_2080RCM445 = ["Canada-USA 2051-2080", 2071, 2080, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2051_2080]
    CanUSA2041_2070RCM445 = ["Canada-USA 2041-2070", 2061, 2070, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2041_2070]
    CanUSA2031_2060RCM445 = ["Canada-USA 2031-2060", 2051, 2060, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2031_2060]
    CanUSA2021_2050RCM445 = ["Canada-USA 2021-2050", 2041, 2050, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2021_2050]
    CanUSA2011_2040RCM445 = ["Canada-USA 2011-2040", 2031, 2040, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2011_2040]
    CanUSA2001_2030RCM445 = ["Canada-USA 2001-2030", 2021, 2030, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA2001_2030]
    CanUSA1991_2020RCM445 = ["Canada-USA 1991-2020", 2011, 2020, ClimateModel.RCM4, RCP.RCP45, ShortNormals.CanUSA1991_2020]

    ### RCM4 model + RCP 8.5
    CanUSA2071_2100RCM485 = ["Canada-USA 2071-2100", 2091, 2100, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2071_2100]
    CanUSA2061_2090RCM485 = ["Canada-USA 2061-2090", 2081, 2090, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2061_2090]
    CanUSA2051_2080RCM485 = ["Canada-USA 2051-2080", 2071, 2080, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2051_2080]
    CanUSA2041_2070RCM485 = ["Canada-USA 2041-2070", 2061, 2070, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2041_2070]
    CanUSA2031_2060RCM485 = ["Canada-USA 2031-2060", 2051, 2060, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2031_2060]
    CanUSA2021_2050RCM485 = ["Canada-USA 2021-2050", 2041, 2050, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2021_2050]
    CanUSA2011_2040RCM485 = ["Canada-USA 2011-2040", 2031, 2040, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2011_2040]
    CanUSA2001_2030RCM485 = ["Canada-USA 2001-2030", 2021, 2030, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA2001_2030]
    CanUSA1991_2020RCM485 = ["Canada-USA 1991-2020", 2011, 2020, ClimateModel.RCM4, RCP.RCP85, ShortNormals.CanUSA1991_2020]

    ### GCM4 model + RCP 4.5
    CanUSA2071_2100GCM445 = ["Canada-USA 2071-2100", 2091, 2100, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2071_2100]
    CanUSA2061_2090GCM445 = ["Canada-USA 2061-2090", 2081, 2090, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2061_2090]
    CanUSA2051_2080GCM445 = ["Canada-USA 2051-2080", 2071, 2080, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2051_2080]
    CanUSA2041_2070GCM445 = ["Canada-USA 2041-2070", 2061, 2070, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2041_2070]
    CanUSA2031_2060GCM445 = ["Canada-USA 2031-2060", 2051, 2060, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2031_2060]
    CanUSA2021_2050GCM445 = ["Canada-USA 2021-2050", 2041, 2050, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2021_2050]
    CanUSA2011_2040GCM445 = ["Canada-USA 2011-2040", 2031, 2040, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2011_2040]
    CanUSA2001_2030GCM445 = ["Canada-USA 2001-2030", 2021, 2030, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA2001_2030]
    CanUSA1991_2020GCM445 = ["Canada-USA 1991-2020", 2011, 2020, ClimateModel.GCM4, RCP.RCP45, ShortNormals.CanUSA1991_2020]

    ### GCM4 model + RCP 8.5
    CanUSA2071_2100GCM485 = ["Canada-USA 2071-2100", 2091, 2100, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2071_2100]
    CanUSA2061_2090GCM485 = ["Canada-USA 2061-2090", 2081, 2090, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2061_2090]
    CanUSA2051_2080GCM485 = ["Canada-USA 2051-2080", 2071, 2080, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2051_2080]
    CanUSA2041_2070GCM485 = ["Canada-USA 2041-2070", 2061, 2070, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2041_2070]
    CanUSA2031_2060GCM485 = ["Canada-USA 2031-2060", 2051, 2060, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2031_2060]
    CanUSA2021_2050GCM485 = ["Canada-USA 2021-2050", 2041, 2050, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2021_2050]
    CanUSA2011_2040GCM485 = ["Canada-USA 2011-2040", 2031, 2040, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2011_2040]
    CanUSA2001_2030GCM485 = ["Canada-USA 2001-2030", 2021, 2030, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA2001_2030]
    CanUSA1991_2020GCM485 = ["Canada-USA 1991-2020", 2011, 2020, ClimateModel.GCM4, RCP.RCP85, ShortNormals.CanUSA1991_2020]
    
    ### Past climate
    CanUSA1981_2010 = ["Canada-USA 1981-2010", 2001, 2010, ClimateModel.RCM4, RCP.PastClimate, ShortNormals.CanUSA1981_2010]
    CanUSA1971_2000 = ["Canada-USA 1971-2000", 1991, 2000, ClimateModel.RCM4, RCP.PastClimate, ShortNormals.CanUSA1971_2000]
    CanUSA1961_1990 = ["Canada-USA 1961-1990", 1981, 1990, ClimateModel.RCM4, RCP.PastClimate, ShortNormals.CanUSA1961_1990]
    CanUSA1951_1980 = ["Canada-USA 1951-1980", 1971, 1980, ClimateModel.RCM4, RCP.PastClimate, ShortNormals.CanUSA1951_1980]
    CanUSA1941_1970 = ["Canada-USA 1941-1970", 1961, 1970, ClimateModel.RCM4, RCP.PastClimate, ShortNormals.CanUSA1941_1970]
